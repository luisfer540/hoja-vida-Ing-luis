export const experienciaObrasCiviles = [
  ...
  {
    empresa: 'Work Construcciones S.A.S',
    url: 'https://www.workconstrucciones.com',
  ...
  {
    empresa: 'Constructora Berlin S.A.S',
    url: 'https://www.constructoraberlin.com',
    cargo: 'Supervisor de obra',
  ...
  {
    empresa: ' CGR SAS',
    url: 'https://www.cgrsas.com/web/content/',
  ...
  {
    empresa: ' Inmag SAS',
    url: 'https://directorio-empresas.einforma.co/informacion-empresa/inmag-ingenieria-sas',
  ...
  },
   {
    ...
    cargo: ' Encargado de obra ',
    fecha: '10/04/2012 - 15/09/2012 (pasantias)',
    proyecto: 'casa de la cultura y plazoleta del cafe del pueblo Genova Quindio',
    certificado: '/experiencia/sena/certificado.png',
    imagenes: [
      { src: '/experiencia/sena/certificado.png', descripcion: 'UPS, te pido disculpas, no tengo registro fotografico' },
